import { makeApplicationCloseOutTxnFromObject, OnApplicationComplete } from 'algosdk';
 ...
 */
export function makeApplicationCloseOutTxn(params) {
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to create application close-out transaction: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
/**
 ...
 */
export function handleCloseOutTxn(args, suggestedParams) {
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to handle application close-out: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
