import { makeApplicationClearStateTxnFromObject, OnApplicationComplete } from 'algosdk';
 ...
 */
export function makeApplicationClearStateTxn(params) {
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to create application clear state transaction: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
/**
 ...
 */
export function handleClearTxn(args, suggestedParams) {
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to handle application clear state: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
