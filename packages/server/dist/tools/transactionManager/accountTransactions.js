import { makePaymentTxnWithSuggestedParamsFromObject, makeKeyRegistrationTxnWithSuggestedParamsFromObject } from 'algosdk';
        ...
        switch (name) {
            case 'make_payment_txn':
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InvalidParams, `Failed to create payment transaction: ${error instanceof Error ? error.message : String(error)}`);
                }
            ...
            default:
                throw new McpError(ErrorCode.MethodNotFound, `Unknown account transaction tool: ${name}`);
        }
    }
}
