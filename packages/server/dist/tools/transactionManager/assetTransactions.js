import { makeAssetCreateTxnWithSuggestedParamsFromObject, makeAssetConfigTxnWithSuggestedParamsFromObject, makeAssetDestroyTxnWithSuggestedParamsFromObject, makeAssetFreezeTxnWithSuggestedParamsFromObject, makeAssetTransferTxnWithSuggestedParamsFromObject } from 'algosdk';
...
export class AssetTransactionManager {
    ...
    static async handleTool(name, args) {
        ...
        switch (name) {
            ...
            default:
                throw new McpError(ErrorCode.MethodNotFound, `Unknown asset transaction tool: ${name}`);
        }
    }
}
