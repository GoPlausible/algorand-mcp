...
export class UtilityManager {
    ...
    static async handleTool(name, args) {
        try {
            switch (name) {
                ...
                case 'sign_bytes': {
                    ...
                    try {
                        ...
                        throw new McpError(ErrorCode.InvalidParams, `Failed to sign bytes: ${error instanceof Error ? error.message : String(error)}`);
                    }
                }
                case 'encode_obj': {
                    ...
                    try {
                        ...
                        throw new McpError(ErrorCode.InvalidParams, `Failed to encode object: ${error instanceof Error ? error.message : String(error)}`);
                    }
                }
                case 'decode_obj': {
                    if (!args.bytes || typeof args.bytes !== 'string') {
                    ...
                    try {
                        ...
                        throw new McpError(ErrorCode.InvalidParams, `Failed to decode object: ${error instanceof Error ? error.message : String(error)}`);
                    }
                }
                case 'verify_bytes':
            ...
            throw new McpError(ErrorCode.InternalError, `Operation failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
    ...
    static isValidAddress(address) {
        try {
            ...
            throw new McpError(ErrorCode.InvalidParams, `Invalid address format: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
     ...
     */
    static encodeAddress(publicKey) {
        try {
            return algosdk.encodeAddress(new Uint8Array(publicKey));
        }
        catch (error) {
            console.error('[MCP Error] Failed to encode address:', error);
            throw new McpError(ErrorCode.InvalidParams, `Invalid public key: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
    ...
    static decodeAddress(address) {
        try {
            ...
            throw new McpError(ErrorCode.InvalidParams, `Invalid address: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
     ...
     */
    static getApplicationAddress(appId) {
        try {
            return algosdk.getApplicationAddress(appId);
        }
        catch (error) {
            console.error('[MCP Error] Failed to get application address:', error);
            throw new McpError(ErrorCode.InvalidParams, `Invalid application ID: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
    ...
    static bytesToBigInt(bytes) {
        try {
            ...
            throw new McpError(ErrorCode.InvalidParams, `Invalid bytes format: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
     ...
     */
    static bigIntToBytes(value, size) {
        try {
            ...
            throw new McpError(ErrorCode.InvalidParams, `Invalid BigInt value or size: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
     ...
     */
    static encodeUint64(value) {
        try {
            return this.bigIntToBytes(value, 8);
        }
        catch (error) {
            console.error('[MCP Error] Failed to encode uint64:', error);
            throw new McpError(ErrorCode.InvalidParams, `Invalid uint64 value: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
     ...
     */
    static decodeUint64(bytes) {
        try {
            return this.bytesToBigInt(bytes);
        }
        catch (error) {
            console.error('[MCP Error] Failed to decode uint64:', error);
            throw new McpError(ErrorCode.InvalidParams, `Invalid uint64 bytes: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
     ...
     */
    static verifyBytes(bytes, signature, address) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InvalidParams, `Failed to verify: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
}
