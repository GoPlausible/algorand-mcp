...
export const ultradeTools = [
    ...walletTools,
    ...marketTools,
    ...systemTools
];
// Handle all Ultrade tools
export async function handleUltradeTools(name, args) {
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to handle Ultrade tool: ${error instanceof Error ? error.message : String(error)}`);
    }
}
