...
export const handleSwapTools = ResponseProcessor.wrapResourceHandler(async function handleSwapTools(args) {
    ...
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to fetch swap data: ${error instanceof Error ? error.message : String(error)}`);
    }
});
