...
export const handleBalanceTools = ResponseProcessor.wrapResourceHandler(async function handleBalanceTools(args) {
    ...
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to fetch balance data: ${error instanceof Error ? error.message : String(error)}`);
    }
});
