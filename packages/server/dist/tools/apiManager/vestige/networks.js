...
export const handleNetworkTools = ResponseProcessor.wrapResourceHandler(async function handleNetworkTools(args) {
    ...
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to fetch network data: ${error instanceof Error ? error.message : String(error)}`);
    }
});
