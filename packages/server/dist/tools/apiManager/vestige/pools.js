...
export const handlePoolTools = ResponseProcessor.wrapResourceHandler(async function handlePoolTools(args) {
    ...
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to fetch pool data: ${error instanceof Error ? error.message : String(error)}`);
    }
});
