...
export const handleNoteTools = ResponseProcessor.wrapResourceHandler(async function handleNoteTools(args) {
    ...
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to fetch note data: ${error instanceof Error ? error.message : String(error)}`);
    }
});
