...
export async function lookupAssetByID(assetId) {
    try {
...
export async function lookupAssetBalances(assetId, params) {
    try {
...
export async function lookupAssetTransactions(assetId, params) {
    try {
...
export async function searchForAssets(params) {
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to search assets: ${error instanceof Error ? error.message : String(error)}`);
    }
}
export const handleAssetTools = ResponseProcessor.wrapResourceHandler(async function handleAssetTools(args) {
