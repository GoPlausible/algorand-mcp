...
export async function getApplicationBoxByName(appId, boxName) {
    try {
        let boxNameBytes;
        ...
        const response = await algodClient.getApplicationBoxByName(appId, boxNameBytes).do();
...
export async function getApplicationBoxes(appId, maxBoxes) {
    try {
...
export async function handleApplicationTools(name, args) {
    switch (name) {
