...
export async function handleTinymanTools(name, args) {
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to handle Tinyman tool: ${error instanceof Error ? error.message : String(error)}`);
    }
}
