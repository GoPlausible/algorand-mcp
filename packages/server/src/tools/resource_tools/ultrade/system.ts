...
export const systemTools: Tool[] = [
  {
    name: 'resource_ultrade_system_time',
  ...
  {
    name: 'resource_ultrade_system_maintenance',
  ...
  {
    name: 'resource_ultrade_system_version',
...
export async function handleSystemTools(args: any): Promise<any> {
  switch (args.name) {
    case 'resource_ultrade_system_time':
      return await getSystemTime();
    case 'resource_ultrade_system_maintenance':
      return await getSystemMaintenance();
    case 'resource_ultrade_system_version':
