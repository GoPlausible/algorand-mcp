...
export const marketTools: Tool[] = [
  ...
  {
    name: 'resource_ultrade_market_chains',
  ...
  {
    name: 'resource_ultrade_market_withdrawal_fee',
  ...
  {
    name: 'resource_ultrade_market_operation_details',
  ...
  {
    name: 'resource_ultrade_market_markets',
  ...
  {
    name: 'resource_ultrade_market_balances',
  ...
  {
    name: 'resource_ultrade_market_order_message',
  ...
  {
    name: 'resource_ultrade_market_create_orders',
  ...
  {
    name: 'resource_ultrade_market_create_order',
  ...
  {
    name: 'resource_ultrade_market_cancel_orders',
  ...
  {
    name: 'resource_ultrade_market_cancel_order',
  ...
  // Market Information
  {
    name: 'resource_ultrade_market_price',
  ...
  {
    name: 'resource_ultrade_market_depth',
  ...
  {
    name: 'resource_ultrade_market_last_trades',
  ...
  {
    name: 'resource_ultrade_market_symbols',
  ...
  {
    name: 'resource_ultrade_market_settings',
  ...
  {
    name: 'resource_ultrade_market_details',
  ...
  // Order Operations
  {
    name: 'resource_ultrade_market_order_by_id',
  ...
  {
    name: 'resource_ultrade_market_orders',
  ...
  {
    name: 'resource_ultrade_market_open_orders',
  ...
  // Other Market Data
  {
    name: 'resource_ultrade_market_history',
  ...
  {
    name: 'resource_ultrade_market_assets',
  ...
  {
    name: 'resource_ultrade_market_fee_rates',
...
export async function handleMarketTools(args: any): Promise<any> {
  switch (args.name) {
    case 'resource_ultrade_market_price':
      return await getMarketPrice(args.symbol);
    
    case 'resource_ultrade_market_depth':
      return await getMarketDepth(args.symbol, args.depth);
    
    case 'resource_ultrade_market_last_trades':
      return await getLastTrades(args.symbol, args.limit);
    
    case 'resource_ultrade_market_symbols':
      return await getMarketSymbols();
    
    case 'resource_ultrade_market_settings':
      return await getMarketSettings(args.domain);
    
    case 'resource_ultrade_market_details':
      return await getMarketDetails(args.symbol);
    
    case 'resource_ultrade_market_order_by_id':
    ...
    case 'resource_ultrade_market_orders':
    ...
    case 'resource_ultrade_market_open_orders':
    ...
    case 'resource_ultrade_market_history':
    ...
    case 'resource_ultrade_market_assets':
      return await getMarketAssets();
    
    case 'resource_ultrade_market_fee_rates':
      return await getFeeRates();
    
    case 'resource_ultrade_market_chains':
      return await getChains();

    case 'resource_ultrade_market_withdrawal_fee':
    ...
    case 'resource_ultrade_market_operation_details':
      return await getOperationDetails(args.operationId);

    case 'resource_ultrade_market_markets':
      return await getMarkets();

    case 'resource_ultrade_market_balances':
    ...
    case 'resource_ultrade_market_order_message':
      return await getOrderMessage(args.data);

    case 'resource_ultrade_market_create_orders':
    ...
    case 'resource_ultrade_market_create_order':
    ...
    case 'resource_ultrade_market_cancel_orders':
    ...
    case 'resource_ultrade_market_cancel_order':
