...
export const handleSwapTools = ResponseProcessor.wrapResourceHandler(async function handleSwapTools(args: any): Promise<any> {
  ...
  switch (name) {
    case 'resource_vestige_view_swaps':
      endpoint = '/swaps';
      break;
    case 'resource_vestige_get_best_v4_swap_data':
      endpoint = '/swap/v4';
      break;
    case 'resource_vestige_get_v4_swap_discount':
      endpoint = '/swap/v4/fee';
      break;
    case 'resource_vestige_get_v4_swap_data_transactions':
      endpoint = '/swap/v4/transactions';
      method = 'POST';
      break;
    case 'resource_vestige_get_aggregator_stats':
