...
export async function lookupAssetBalances(assetId: number, params?: {
  ...
  try {
    ...
    console.error('Asset balances response:', JSON.stringify(response, null, 2));
    return response;
  } catch (error) {
...
export async function lookupAssetTransactions(assetId: number, params?: {
  ...
  try {
    ...
    console.error('Asset transactions response:', JSON.stringify(response, null, 2));
    return response;
  } catch (error) {
...
export async function searchForAssets(params?: {
  ...
  try {
    ...
    console.error('Search assets response:', JSON.stringify(response, null, 2));
    return response;
  } catch (error) {
