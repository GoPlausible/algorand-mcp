    ...
    switch (name) {
      case 'make_asset_create_txn':
        ...
        if (typeof args.assetMetadataHash === 'string') {
          ...
          createTxnParams.assetMetadataHash = algosdk.bytesToBase64(metadataBytes);
        }
        ...
        if (typeof args.note === 'string') {
          ...
          createTxnParams.note = algosdk.bytesToBase64(noteBytes);
        }
      ...
      case 'make_asset_config_txn':
        ...
        if (typeof args.note === 'string') {
          const noteBytes = new TextEncoder().encode(args.note);
          configTxnParams.note = algosdk.bytesToBase64(noteBytes);
        }
        if (typeof args.rekeyTo === 'string') {
      ...
      case 'make_asset_destroy_txn':
        ...
        if (typeof args.note === 'string') {
          const noteBytes = new TextEncoder().encode(args.note);
          destroyTxnParams.note = algosdk.bytesToBase64(noteBytes);
        }
        if (typeof args.rekeyTo === 'string') {
      ...
      case 'make_asset_freeze_txn':
        ...
        const freezeTxnParams: Record<string, any> = {
          ...
          frozen: Boolean(args.freezeState),
          fee: suggestedParams.fee,
          firstValid: suggestedParams.firstValid,
          lastValid: suggestedParams.lastValid,
          genesisID: suggestedParams.genesisID,
        ...
        if (typeof args.note === 'string') {
          const noteBytes = new TextEncoder().encode(args.note);
          freezeTxnParams.note = algosdk.bytesToBase64(noteBytes);
        }
        if (typeof args.rekeyTo === 'string') {
      ...
      case 'make_asset_transfer_txn':
        ...
        if (typeof args.note === 'string') {
          const noteBytes = new TextEncoder().encode(args.note);
          transferTxnParams.note = algosdk.bytesToBase64(noteBytes);
        }
